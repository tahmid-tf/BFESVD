        ...
        <div class="col-md-12">
            <div class="left-side-div-padding">
                ...
                <div class="tutorial text-center">
                    <iframe width="560" height="315" src="{{ \App\Background::videoLink()->link ?? 'https://www.youtube.com/embed/B7bCCyrNbPc'}}"
                        ...
                        <div class="right-side-button-div">
                            ...
                            <div>
                                @if(session('tracker'))
                                    ...
                                    <a href="{{ route('start.survey') }}">
                                        <button class="view-data-button">Continue Survey <br> {{ session('tracker') }}
                                        </button>
                                    </a>
                                @else
                                    <a href="{{ route('start.survey') }}">
                                        <button class="view-data-button">Start Survey</button>
                                    </a>
                                @endif
                            ...
                            @if(session('tracker'))
                                ...
                                <div>
                                    <a href="{{ route('user-forget-tracker') }}">
                                        <button class="view-data-button" style="background-color: red">Clear session
                                        </button>
                                    </a>
                                </div>
                            ...
                            <div>
                                <a href="{{ route('edit.survey') }}">
                                    <button class="view-data-button">Edit Survey</button>
                                </a>
                            </div>
                        </div>
                    </div>
