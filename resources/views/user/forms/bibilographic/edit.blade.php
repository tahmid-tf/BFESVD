...
<section class="container">
    ...
    <form action="{{ route('bibilographic.update',session('tracker')) }}" method="post">
        {{ csrf_field() }}
        @method('put')
        ...
        <br>
        <textarea name="author">{{ $tracking->author }}</textarea><br>
        ...
        <br>
        <input type="" name="year_publication" value="{{ $tracking->year_publication }}"><br>
        ...
        <br>
{{--        <input type="" name="title" value="{{ $tracking->title }}"><br>--}}

        <textarea name="title">{{ $tracking->title }}</textarea><br>
        ...
        <br>
        <textarea name="full_reference">{{ $tracking->full_reference }}</textarea><br>
        ...
        <br>
        <textarea name="study_link">{{ $tracking->study_link }}</textarea><br>
        ...
        <br>
        <textarea name="research_link">{{ $tracking->research_link }}</textarea><br>
        ...
        <textarea style="width: 50%"
                  @if(auth()->user()->role == "user")  @endif name="comment">{{ $tracking->comment }}</textarea><br/><br/>
