        ...
        <section class="container">
            ...
            <input type="checkbox" name="valuationMethod" value="Value Transfer" v-model="valuation_method"> Value Transfer  </span><br>
              ...
              <span class="popuptext" id="myPopup2">Text description of the change in ecosystem service, extent of ecosystem,
                  ...
                  value of timber extracted by local people of the Rangamati district, average annual willingness to pay for storm protection,
                  total monetary loss associated with the cyclone. You may directly copy and paste from the study.</span>
            </span>
                </label>
                <br>
              ...
              <span class="popuptext" id="myPopup10">The beneficiary unit name for which the value is reported (e.g. visitor,
                  person, household, or total number of beneficiaries). </span>
            </span>
                </label>
                <br>
                <span class="forest-zone"
            ...
            <input type="checkbox" name="beneficiaryUnit" value="Total_Number" v-model="beneficial_unit"> Total Number </span>
              ...
              <span class="popuptext" id="myPopup11">The number of beneficiaries that benefit from the ecosystem service.
                  ...
                  estimate is extrapolated to obtain a total value of the service. This is NOT the sample size or number
                  of beneficiaries surveyed.</span>
            </span>
                </label>
                <br>
              ...
              <span class="popuptext" id="myPopup12">Text description of the type of beneficiary of the service (e.g. visitors,
                  residents, non-users, tourists etc.). You may directly copy and paste from the study. </span>
            </span>
                </label>
                <br>
    ...
    var app = new Vue({
        ...
        methods: {
            submitData() {
                ...
                //
                //
                axios.post('{{ route('valuation.store') }}', formData).then(el => {
                    if(el.status == 200){
