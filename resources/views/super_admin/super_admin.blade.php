    ...
    <div class="row" style="margin: 0; padding: 0">
        ...
        <div class="col-md-6">
            <div class="left-side-div-padding">
                ...
                <div class="col-md-12">
                    <div class="right-side-div-padding">
                        ...
                        <div class="right-side-button-div">
                            ...
                            <div>
                                <a href="{{ route('super-admin-view-admin-table') }}">
                            ...
                            <a href="{{ route('super_admin.survey') }}">
                                <div>
                ...
                <div class="col-md-12">
                    <div class="right-side-div-padding">
                        <p class="right-side-div-title" style="color: #009797">Content and user management</p>
                        <div class="right-side-button-div">


                            {{--  -------------------- View Users ----------------- --}}
                            <div>
                                <a href="{{ route('user-creation') }}">
                                    <button class="view-data-button" style="background-color: #009797">View Users
                                    </button>
                                </a>
                            </div>
                            {{--  -------------------- View Users ----------------- --}}
                            ...
                            <div>
                                <a href="{{ route('cms.dashboard') }}">
                                    <button class="view-data-button" style="background-color: #DC1717">CMS Service
                                    </button>
                                </a>
                            </div>
                ...
                <!-- -------------- end - Content and user management ---------- -->
            </div>
        </div>
